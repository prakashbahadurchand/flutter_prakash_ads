...
import 'package:flutter_ads/flutter_ads.dart' as _i600;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i600.AdsService>(() => adsModule.provideAdsService());
    gh.lazySingleton<_i600.AppOpenAdManager>(
      () => adsModule.provideAppOpenAdManager(),
    );
    gh.lazySingleton<_i161.InternetConnection>(
      () => networkModule.provideInternetConnection(),
    );
    gh.lazySingleton<_i600.NetworkInfo>(
    ...
    gh.lazySingleton<_i168.AdsCubit>(
      () => _i168.AdsCubit(adsService: gh<_i600.AdsService>()),
    );
    return this;
  }
}
