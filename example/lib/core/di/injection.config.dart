...
import 'package:fp_ads/fp_ads.dart' as _i185;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i185.AdsService>(() => adsModule.provideAdsService());
    gh.lazySingleton<_i185.AppOpenAdManager>(
      () => adsModule.provideAppOpenAdManager(),
    );
    gh.lazySingleton<_i161.InternetConnection>(
      () => networkModule.provideInternetConnection(),
    );
    gh.lazySingleton<_i185.NetworkInfo>(
    ...
    gh.lazySingleton<_i168.AdsCubit>(
      () => _i168.AdsCubit(adsService: gh<_i185.AdsService>()),
    );
    return this;
  }
}
